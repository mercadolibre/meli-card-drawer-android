...
class NumberFormatterTest {
    ...
    @Test
    fun `when format text with separated filled text processor and amex pattern with full number then it should return grouped string`() {
    ...
    @Test
    fun `when format text with pattern with zero value then it should return grouped String`() {
    ...
    @Test
    fun `when format text with empty pattern then it should return empty String`() {
    ...
    @Test
    fun `when format text with separated filled text processor and visa pattern with full number then it should return grouped string`() {
    ...
    @Test
    fun `when format text with separated filled text processor and visa pattern with half filled number then it should return grouped string with fillers`() {
        val pattern = intArrayOf(4, 4, 4, 4)
